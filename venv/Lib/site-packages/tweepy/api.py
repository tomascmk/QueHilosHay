...
class API(object):
    ...
    def send_direct_message(self, recipient_id, text, quick_reply_type, attachment_type=None, attachment_media_id=None):
        ...
        if quick_reply_type is not None:
            json_payload['event']['message_create']['message_data']['quick_reply'] = {'type': 'options', 'options': [{"label": "Si quiero Boti.",
                                                                                                                      "description": "Si quiero Boti.",
                                                                                                                      "metadata": "Si quiero Boti."
                                                                                                                    },
                                                                                                                    {
                                                                                                                      "label": "No quiero Boti.",
                                                                                                                      "description": "No quiero Boti.",
                                                                                                                      "metadata": "No quiero Boti."
                                                                                                                    }]}
